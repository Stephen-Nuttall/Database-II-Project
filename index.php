...
<body>
    ...
    If the email provided does not have an account, a new account will be created.<br>
    If you are creating an account, you do not need to enter a current password.<br>
    If you are modifying an account, please enter your email and current password.
    <form action="item1.php" method="post">
        <table border="0">
            ...
            <tr bgcolor="#cccccc">
                ...
                <td align="left">
                    <input type="text" name="current_password" size="32" maxlength="32" />
                </td>
            </tr>
            <tr bgcolor="#cccccc">
                <td>New Password:</td>
                <td align="left">
                    <input type="text" name="new_password" size="32" maxlength="32" />
                </td>
            </tr>
            <tr bgcolor="#cccccc">
                <td>Name:</td>
            ...
            <tr bgcolor="#cccccc">
                ...
                <td align="left">
                    <select name="dept">
                        <option value="Miner School of Computer & Information Sciences">Computer Science</option>
                    </select>
                </td>
            </tr>
            <tr bgcolor="#cccccc">
